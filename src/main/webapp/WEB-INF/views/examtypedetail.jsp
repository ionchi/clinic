		...
		<div class="container-fluid">
			...
			<div id="navbar"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${pageContext.request.contextPath}/default">Area personale <span
...
<div class="container content" style="background-color: #fff;">
	<div>
		<div class="text-center">
			<h1>Nome: ${examtype.name}</h1>
			<h3>
				Costo: <span style="color: red;">${examtype.cost} $ </span>
			</h3>
			<div>Descrizione: ${examtype.description}</div>
		</div>
		<br />
		<div>
			<div>
