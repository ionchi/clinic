		...
		<div class="container-fluid">
			...
			<div id="navbar"
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="${pageContext.request.contextPath}/default">Area
			...
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/admin/addpatient"
						class="btn btn-large btn-lg btn-block">Inserisci un paziente</a>
				</div>
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/admin/addexam"
					   class="btn btn-large btn-lg btn-block">Crea esame
						(prenotazione)</a>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/admin/listexamtype"
						class="btn btn-large btn-lg btn-block">Inserisci tipologia di
						esame</a>
				</div>
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/workinprogress"
					   class="btn btn-large btn-lg btn-block">Inserisci i risultati
						di un esame</a>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/admin/adddoctor"
						class="btn btn-large btn-lg btn-block">Inserisci un medico</a>
				</div>
				<div class="col-sm-12 col-md-6">
					<a href="${pageContext.request.contextPath}/admin/searchdoctor"
						class="btn btn-large btn-lg btn-block">Visualizza esami
						effetuati da un medico</a>
				</div>
			</div>
		</div>
	</div>
