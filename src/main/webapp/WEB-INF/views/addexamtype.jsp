...
<head>
	...
	<title>Aggiungi tipologia esame</title>
	<!-- Bootstrap -->
	...
	<div class="row">
		<div
			...
			<form:form method="POST" modelAttribute="examtype"
				...
				<h2 class="text-center">Inserisci tipologia esame nel database</h2>
				<hr class="colorgraph">
				<div>
					...
					<div class="form-group col-sm-12 col-md-8 col-md-offset-2">
						<form:input path="cost" cssClass="form-control input-lg"
									placeholder="Costo ($)" />
					</div>
					<div class="form-group col-sm-12 col-md-8">
						<form:errors path="cost" cssClass="alert alert-danger" />
					</div>
					<div class="form-group col-sm-12 col-md-8 col-md-offset-2">
						<form:textarea cssClass="form-control" rows="4" maxlength="200"
									   path="description" placeholder="Descrizione" tabindex="4"
									   cssStyle="resize: none; font-size: 18px;" />
					</div>
				</div>
				<div class="row">
					...
					<br />
					<div class="col-sm-12 col-md-6">
						<a href="listexamtype" class="btn btn-primary btn-block btn-lg">
							Lista Tipologie esami </a>
					</div>
				</div>
			</form:form>
		</div>
