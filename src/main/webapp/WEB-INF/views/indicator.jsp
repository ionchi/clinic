...
<div class="container content" style="background-color: #fff;">
    <h1>Lista indicatori per: ${examtype.name} </h1>
    <div align="center">
        <table class="table table-hover table-striped">
            ...
            <c:forEach var="indicator" items="${indicatorList}"
                ...
                <tr>
                    ...
                    <td><a
                            href="${pageContext.request.contextPath}/admin/deleteInd/${examTypeId}/${indicator.id}" class="btn btn-danger ">Cancella</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <div>
            <a href="${pageContext.request.contextPath}/admin/addindicator/${examTypeId}"
               class="btn btn-success">Inserisci indicatore</a>
