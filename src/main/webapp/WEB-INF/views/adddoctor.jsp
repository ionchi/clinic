	...
	<div class="row">
		<div
			...
			<form:form method="POST" modelAttribute="doctor"
					   action="updatedoctor">
				<h2 class="text-center">Inserisci medico nel database</h2>
				<hr class="colorgraph">
				<div>
					...
					<div class="form-group col-sm-12 col-md-8 col-md-offset-2">
						<form:input path="specialization"
									cssClass="form-control input-lg" placeholder="Specializzazione" />
					</div>
					<div class="form-group col-sm-12 col-md-6 col-md-offset-3">
						<form:errors path="specialization" cssClass="alert alert-danger" />
					</div>
				</div>
				<div class="row">
