...
<head>
    ...
    <title>Lista prerequisiti</title>
    <!-- Bootstrap -->
...
<div class="container content" style="background-color: #fff;">
    <h1>Lista prerequsiti per: ${examtype.name} </h1>
    <div align="center">
        <table class="table table-hover table-striped">
            ...
            <tbody>
            <c:forEach var="prerequisite" items="${prerequisteList}"
                       varStatus="status">
                <tr>
                    ...
                    <td><a
                            href="${pageContext.request.contextPath}/admin/deletePre/${examTypeId}/${prerequisite.id}" class="btn btn-danger ">Cancella</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <div>
            <a href="${pageContext.request.contextPath}/admin/addprerequisite/${examTypeId}"
               class="btn btn-success">Inserisci prerequisito</a>
            <a href="${pageContext.request.contextPath}/admin/listexamtype"
               class="btn btn-primary">Tipologie esame</a>
        </div>
        <br />
    </div>
</div>
